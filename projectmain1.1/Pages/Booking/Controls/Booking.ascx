<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Booking.ascx.cs" Inherits="projectmain1._1.Pages.Booking.Controls.Booking" %>
<%@ Register Src="~/Pages/Booking/Controls/Menu.ascx" TagPrefix="uc1" TagName="Menu" %>
        ...
        <tr>
            ...
            <td>
                <div class="input-group">
                    ...
                    <asp:TextBox ID="txtemail" runat="server" CssClass="form-control mandatory" placeholder="you@example.com" OnTextChanged="txtemail_TextChanged" TextMode="Email"></asp:TextBox>
...
<hr class="mb-4">
<asp:Button ID="btnSubmit" CssClass="btn btn-primary btn-lg" runat="server" href="../CheckOut.aspx" Text="Check out" BackColor="#009900" OnClick="btnSubmit_Click" />
